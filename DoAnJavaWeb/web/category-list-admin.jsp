...
<html>
                        ...
                        <div class="row w-100 d-flex justify-content-between"> 
                            ...
                            <div class="col-2">
                                <button class="btn btn-info btn-block" type="button">
                                    <a class="btnAdd" href="category-form.jsp" style="text-decoration: none" >
                                        Add Category
                                    </a>
                                </button>
                            </div>
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-center  " colspan="2">Mã danh mục</th>
                                                        <th scope="col"  colspan="3">Tên tên danh mục</th>                            
                                                        <th scope="col" class="text-center  " colspan="4">Tiện ích</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <% int stt = 1;%>
                                                    <c:forEach items="${listdm}" var = "c" >
                                                        <tr>
                                                            ...
                                                            <td colspan="2" class="text-center  "><c:out value = "${c.ma}"/></td>
                                                            <td colspan="3" class="fw-bold text-nowrap" style="text-transform:capitalize"><c:out value = "${c.ten}"/></a></td>
                                                            <td colspan="4"> 
                                                                <div class="d-flex justify-content-between mx-5 align-items-center">
                                                                     <button style="height:3rem;width: 5rem; "  type="button" class="btn btn-success mb-1" >
                                                                    <a  style="text-decoration:none" class="btnAdd" href="DanhMucController?action=UPDATE&ma=${c.ma}">Sửa</a>
                                                                </button>
                                                                <button style="height:3rem;width: 5rem;  " type="button" onclick="showMess('${c.ma}')" class="btn btn-danger">Xóa</button>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
    ...
    <script>
        ...
        function showMess(madt) {
            ...
            if (option === true) {
                window.location.href = 'DanhMucController?action=DELETE&ma=' + madt;
            }
