...
public class HomeController extends HttpServlet {
 private static final long serialVersionUID = 1L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listProductEnd = productDAO.get(listProduct.size() - 8, 8);
        request.setAttribute("listP", listProductEnd);
...
//        if ( id == null) {
//            listDanhMucVaSach(request, response);
//        }
//        listDanhMucVaSachBangDanhMuc(Integer.parseInt(id), request, response);
        //processRequest(request, response);
    }
